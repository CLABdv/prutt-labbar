\documentclass{article}\usepackage{noweb}\pagestyle{noweb}\noweboptions{}\begin{document}\nwfilename{Main.nw}\nwbegindocs{0}\title{Laboration 4}% ===> this file was generated automatically by noweave --- better not edit it
...
\nwenddocs{}\nwbegincode{1}\moddef{Component.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\texttt{Component}. Vi implementerar dessa i {\Tt{}AbstractComponent.java\nwendquote}
\nwenddocs{}\nwbegincode{3}\moddef{AbstractComponent.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
public class AbstractComponent implements Component \{
    ...
    public double getWeight() \{
        \LA{}AbstractComponent getWeight\RA{}
    \}
    
    public String toString() \{
        \LA{}AbstractComponent toString\RA{}
    \}
...
Vi gör nu implementationen av {\Tt{}Leaf.java\nwendquote}. Det enda 
vi behöver från denna är en konstruktor som tar vikt och
namn av vad vi nu packar:

\nwenddocs{}\nwbegincode{5}\moddef{Leaf.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{7}\moddef{Composite.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
import java.util.ArrayList;
...
\nwenddocs{}\nwbegincode{9}\moddef{AbstractComponent getWeight}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
double sum = weight;
if (children != null) \{
...
\nwenddocs{}\nwbegincode{11}\moddef{AbstractComponent toString}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
Vi återkommer till klienten (dvs {\Tt{}Main.java\nwendquote}) senare. 
Vi går nu igenom de olika iteratorna. I vår \texttt{Composite}
har vi:

\nwenddocs{}\nwbegincode{13}\moddef{Composite iterator}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
för dessa i {\Tt{}BFIterator.java\nwendquote} respektive {\Tt{}DFIterator.java\nwendquote}.
...
\nwenddocs{}\nwbegincode{15}\moddef{BFIterator.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
import java.util.Iterator;
...
Metodiken i {\Tt{}DFIterator.java\nwendquote} är analog, fast konstruktionen är för en depth-first-iterering:

\nwenddocs{}\nwbegincode{17}\moddef{DFIterator.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
import java.util.Iterator;
import java.util.LinkedList;
...
\nwenddocs{}\nwbegincode{19}\moddef{Main.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{21}\moddef{human/Human.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
package human;
...
\nwenddocs{}\nwbegincode{25}\moddef{human/NonBinary.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
package human;
...
\nwenddocs{}\nwbegincode{27}\moddef{human/Woman.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
package human;
...
Vi testar att detta fungerar i {\Tt{}Factory.java\nwendquote}, notera att vi får compile-time-errors 
om vi avkommenterar kommentarerna. Om assertsen avklaras så skapas våra människor korrekt.

\nwenddocs{}\nwbegincode{29}\moddef{Factory.java}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
