...
class Gameboard extends JPanel {
	...
	private static final Icon[] icons = {
		new ImageIcon("img/rock.gif"), 
		new ImageIcon("img/paper.gif"),
		new ImageIcon("img/scissors.gif")
	};
    private static final String[] texts = {"STEN", "PASE", "SAX"};
    ...
    Gameboard(String name) {
		...
		lowerMess = new JLabel("Ready!", JLabel.CENTER);
    ...
    void markPlayed(String r) {
		...
		lastPlayed.setBackground(Color.orange);
		lastPlayed.requestFocusInWindow();
    }

    // or use JButton as parameter
    void markPlayed(JButton b) {
		lastPlayed = b; 
		lastPlayed.setBackground(Color.red);
		lastPlayed.requestFocusInWindow();
    }
